...
export default function MainPanel ({city,data,capitalize}){
    ...
    const textSize = city.length > 8 ? "text-xl" : "text-2xl"
    ...
    return(
        <div className="flex rounded-3xl bg-[#242424] p-5 items-center justify-evenly md:px-7 md:py-10 md:h-[200px] md:mr-4">
            ...
            <div className="text-3xl text-[#ffffff] font-bold mr-4 md:text-6xl md:ml-4">{Math.round(temperature)}°C </div>
            <div className="flex flex-col justify-center p-2">
                <p className="text-xl text-[#ffffff]">Rain({hour})</p>
                <h3 className="text-xl text-[#ffffff] font-bold">{rain}mm</h3>
            </div>
        </div>
